...
<ul class="tabul"> 
  ...
  <?php if($value['type'] == "section"){ ?>
       ...
       <li class="rm_item" id="<?php echo $value['id']; ?>"> 
           <!--<img src="<?php echo $value['image']; ?>" alt="<?php echo $value['name']; ?>" height="35" width="35" align="left">-->
           <span class="rm_section_title"> <?php echo $value['name']; ?> </span></li>
