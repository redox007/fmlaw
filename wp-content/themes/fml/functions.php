...
if (!defined('THEME_INC'))
    define('THEME_INC', $includes_path);
if (!defined('THEME_OPT'))
    define('THEME_OPT', $options_path);
if (!defined('THEME_PLUG'))
    define('THEME_PLUG', $plugin_path);
if (!defined('THEME_METAS'))
    define('THEME_METAS', $metabox_path);
if (!defined('THEME_CUSTOMIZE'))
    define('THEME_CUSTOMIZE', $customise_path);
