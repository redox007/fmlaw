...
function custom_login_logo() {
    ...
    h1 a { background: url('<?php $logo = get_option('pim_logo'); if($logo) echo $logo; else echo get_bloginfo('template_directory').'/img/logo.png';?>')  no-repeat center top !important ; 
