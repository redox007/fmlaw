...
class MY_ImageContent extends WP_Widget {
    /** constructor */
    function MY_ImageContent() {
        parent::WP_Widget(false, $name = 'Image & Content');    
    }
    ...
    //$height = (esc_attr($instance['height'])) ? esc_attr($instance['height']) : 189;
                ...
                <div class="sidebar-inner">
                    ...
                    <img src="<?php echo $image;?>" class="img-responsive" alt="side-img">
                    <p><?php echo $content; ?><a href="<?php echo $link; ?>" class="s-more">MORE</a></p>
                </div>
